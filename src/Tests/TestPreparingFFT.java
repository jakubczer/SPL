...
import Calculations.PreparingFFT;
import Calculations.WindowFunction;
import Calculations.FFT;

public class TestPreparingFFT {
    ...
    public static void test(String[] arg){
        ...
        X = FFT.fft(PreparingFFT.DataPreparingForFFT(first, WindowFunction.Rectangle));
